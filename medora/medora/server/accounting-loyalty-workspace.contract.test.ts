...
describe("accounting and loyalty workspace contract", () => {
  it("mounts the governed workspace in the finance module", () => {
    ...
    expect(home).toContain("<AccountingLoyaltyWorkspace");
    expect(home).toContain("organizationId={organizationId}");
    expect(home).toContain("branchId={branchId}");
    expect(home).toContain("jurisdictionId={jurisdictionId}");
  });
