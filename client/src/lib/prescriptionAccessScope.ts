 ...
 * scope. Jurisdiction ID 0 is a legal isolated-showcase assignment and must
 * not be discarded by a browser truthiness check; server-side membership
 * assertions remain the authority for every accepted scope.
 */
