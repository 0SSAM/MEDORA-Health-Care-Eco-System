...
ALTER TABLE `automation_outbound_events` ADD `signatureHex` varchar(64);--> statement-breakpoint
ALTER TABLE `scheduled_jobs` ADD `lastInternalEventAt` timestamp;--> statement-breakpoint
ALTER TABLE `scheduled_jobs` ADD `lastInternalEventStatus` enum('never','recorded','failed') DEFAULT 'never' NOT NULL;