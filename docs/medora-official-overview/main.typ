...
#ar[
  *MEDORA* ليس اختصاراً قانونياً أو اسماً لجهة حكومية، وإنما هو تفسير هوياتي وتسويقي مقصود يمكن استخدامه عند التعريف بالمنصة:
]

#align(center)[
  #text(size: 18pt, weight: "bold", fill: report-accent)[MEDORA = Accessible · Localized · Dependable Operations]
  #v(0.5em)
  #text(size: 12pt)[تشغيل صحي متاح، محلي، ويمكن الاعتماد عليه]
]

#ar[
  وتعني *Accessible* أن النظام مصمم ليكون قابلاً للوصول عبر واجهة ويب متجاوبة، و*Localized* أنه يستوعب اللغة العربية والسياق المحلي وحزم القواعد الخاصة بكل دولة، و*Dependable Operations* أنه يركز على التشغيل القابل للتتبع والفشل الآمن والوضوح العملي. أما *MEDORA* فهي امتداد صوتي وهووي لـ *MEDORA* مع دلالة الرعاية والاتساع المؤسسي، ويمكن تقديم الاسم تجارياً بصيغة: *MEDORA | Integrated Health System*.
]

#en[
  *MEDORA* is not a legal acronym or the name of a government body. It is an intentional identity explanation that may be used in formal introductions:
]
...
#en[
  *Accessible* describes browser-based, responsive access; *Localized* describes Arabic-first operation, local terminology, and country-specific rule packs; and *Dependable Operations* describes traceable workflows, safe failure, and operational clarity. *MEDORA* extends the MEDORA identity with a broader healthcare and institutional character. This is a brand interpretation, not a historical claim about the origin of the name.
]
